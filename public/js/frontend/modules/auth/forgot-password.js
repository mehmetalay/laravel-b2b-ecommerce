...
"use strict";
/*!***************************************************************!*\
  !*** ./resources/js/frontend/modules/auth/forgot-password.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initAuthForgotPasswordPage() {
  var form = document.querySelector('[data-js="auth-forgot-password-form"]');
  if (!(form instanceof HTMLFormElement)) {
    return;
  }
  var config = document.querySelector('[data-js="auth-forgot-password-config"]');
