...
"use strict";
/*!************************************************************************!*\
  !*** ./resources/js/frontend/modules/auth/subdealer-reset-password.js ***!
  \************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initSubDealerResetPasswordPage() {
  var form = document.querySelector('[data-js="subdealer-reset-password-form"]');
  if (!(form instanceof HTMLFormElement)) {
    return;
  }
  var config = document.querySelector('[data-js="subdealer-reset-password-config"]');
  ...
  var loadingSubmitText = (config === null || config === void 0 ? void 0 : config.getAttribute('data-loading-submit-text')) || 'Değiştiriliyor, lütfen bekleyin';
