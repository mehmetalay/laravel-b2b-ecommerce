...
"use strict";
/*!***************************************************************!*\
  !*** ./resources/js/frontend/modules/auth/subdealer-login.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initSubDealerLoginPage() {
  var form = document.querySelector('[data-js="subdealer-login-form"]');
  if (!(form instanceof HTMLFormElement)) {
    return;
  }
  var config = document.querySelector('[data-js="subdealer-login-config"]');
  var requestErrorMessage = (config === null || config === void 0 ? void 0 : config.getAttribute('data-request-error')) || 'İstek sırasında bir hata oluştu.';
  var loadingLoginText = (config === null || config === void 0 ? void 0 : config.getAttribute('data-loading-login-text')) || 'Giriş yapılıyor, lütfen bekleyin';
  var loadingChangePasswordText = (config === null || config === void 0 ? void 0 : config.getAttribute('data-loading-change-password-text')) || 'Değiştiriliyor, lütfen bekleyin';
  var contractTitle = (config === null || config === void 0 ? void 0 : config.getAttribute('data-contract-title')) || '';
  var changePasswordTitle = (config === null || config === void 0 ? void 0 : config.getAttribute('data-change-password-title')) || '';
  var confirmButtonText = (config === null || config === void 0 ? void 0 : config.getAttribute('data-confirm-button-text')) || 'Tamam';
  var passwordChangeSuccessMessage = (config === null || config === void 0 ? void 0 : config.getAttribute('data-password-change-success')) || '';
  var notifyAuthValidationError = function notifyAuthValidationError(errors) {
    var _window$notify, _window;
    (_window$notify = (_window = window).notify) === null || _window$notify === void 0 || _window$notify.call(_window, 'error', (0,_shared_forms_helpers__WEBPACK_IMPORTED_MODULE_3__.firstValidationMessage)(errors) || requestErrorMessage);
  };
  var notifyAuthRequestError = function notifyAuthRequestError(errorPayload) {
    var _window$notify2, _window2;
    var notifyType = (errorPayload === null || errorPayload === void 0 ? void 0 : errorPayload.status) === 'warning' ? 'warning' : 'error';
    (_window$notify2 = (_window2 = window).notify) === null || _window$notify2 === void 0 || _window$notify2.call(_window2, notifyType, (errorPayload === null || errorPayload === void 0 ? void 0 : errorPayload.message) || requestErrorMessage);
  };
  var showModal = function showModal(selector) {
    (0,_shared_ui_modal__WEBPACK_IMPORTED_MODULE_4__.showModalPrimitive)(selector, {
      resolveBy: function resolveBy(value) {
        return document.querySelector(value);
      }
    });
  };
  var hideModal = function hideModal(selector) {
    (0,_shared_ui_modal__WEBPACK_IMPORTED_MODULE_4__.hideModalPrimitive)(selector, {
      resolveBy: function resolveBy(value) {
        return document.querySelector(value);
      }
    });
  };
  var setButtonLoadingText = function setButtonLoadingText(button, text) {
    if (!button) {
      return {
  ...
  form.addEventListener('submit', function (event) {
    var _window$setLoading, _window3;
    event.preventDefault();
    var submitButton = form.querySelector('button[type="submit"]');
    var buttonState = setButtonLoadingText(submitButton, loadingLoginText);
    (_window$setLoading = (_window3 = window).setLoading) === null || _window$setLoading === void 0 || _window$setLoading.call(_window3, submitButton, true);
    window.axiosRequest.post(form.action, (0,_shared_forms_helpers__WEBPACK_IMPORTED_MODULE_3__.serializeForm)(form), {
      onSuccess: function onSuccess(data) {
        var _window$setLoading3, _window5, _window$notify3, _window6;
        if (data.type === 'contract_form') {
          var _window$Swal;
          (_window$Swal = window.Swal) === null || _window$Swal === void 0 || _window$Swal.fire({
            icon: 'warning',
            title: contractTitle,
        ...
        if (data.type === 'change_password') {
          var _window$Swal2;
          (_window$Swal2 = window.Swal) === null || _window$Swal2 === void 0 || _window$Swal2.fire({
            icon: 'warning',
            ...
            willClose: function willClose() {
              ...
              (_window$setLoading2 = (_window4 = window).setLoading) === null || _window$setLoading2 === void 0 || _window$setLoading2.call(_window4, submitButton, false);
              buttonState.restore();
              var changePasswordForm = document.getElementById('changePasswordModalForm');
        ...
        (_window$setLoading3 = (_window5 = window).setLoading) === null || _window$setLoading3 === void 0 || _window$setLoading3.call(_window5, submitButton, false);
        buttonState.restore();
        (_window$notify3 = (_window6 = window).notify) === null || _window$notify3 === void 0 || _window$notify3.call(_window6, 'success', data.message || requestErrorMessage);
      },
      onValidationError: function onValidationError(errors) {
        var _window$setLoading4, _window7;
        (_window$setLoading4 = (_window7 = window).setLoading) === null || _window$setLoading4 === void 0 || _window$setLoading4.call(_window7, submitButton, false);
        buttonState.restore();
        notifyAuthValidationError(errors);
      },
      onError: function onError(errorPayload) {
        var _window$setLoading5, _window8;
        (_window$setLoading5 = (_window8 = window).setLoading) === null || _window$setLoading5 === void 0 || _window$setLoading5.call(_window8, submitButton, false);
        buttonState.restore();
  ...
  if (changePasswordForm instanceof HTMLFormElement) {
    changePasswordForm.addEventListener('submit', function (event) {
      var _window$setLoading6, _window9;
      event.preventDefault();
      var submitButton = document.querySelector('button[form="changePasswordModalForm"]') || changePasswordForm.querySelector('button[type="submit"]');
      var buttonState = setButtonLoadingText(submitButton, loadingChangePasswordText);
      (_window$setLoading6 = (_window9 = window).setLoading) === null || _window$setLoading6 === void 0 || _window$setLoading6.call(_window9, submitButton, true);
      window.axiosRequest.post(changePasswordForm.getAttribute('action') || '', (0,_shared_forms_helpers__WEBPACK_IMPORTED_MODULE_3__.serializeForm)(changePasswordForm), {
        onSuccess: function onSuccess(response) {
          var _window$Swal3;
          (_window$Swal3 = window.Swal) === null || _window$Swal3 === void 0 || _window$Swal3.fire({
            icon: 'success',
            ...
            timerProgressBar: true,
            willClose: function willClose() {
              var _window$setLoading7, _window0;
              hideModal('#changePasswordModal');
              (_window$setLoading7 = (_window0 = window).setLoading) === null || _window$setLoading7 === void 0 || _window$setLoading7.call(_window0, submitButton, false);
              buttonState.restore();
            }
          });
        },
        onValidationError: function onValidationError(errors) {
          var _window$setLoading8, _window1;
          (_window$setLoading8 = (_window1 = window).setLoading) === null || _window$setLoading8 === void 0 || _window$setLoading8.call(_window1, submitButton, false);
          buttonState.restore();
          notifyAuthValidationError(errors);
        },
        onError: function onError(errorPayload) {
          var _window$setLoading9, _window10;
          (_window$setLoading9 = (_window10 = window).setLoading) === null || _window$setLoading9 === void 0 || _window$setLoading9.call(_window10, submitButton, false);
          buttonState.restore();
          notifyAuthRequestError(errorPayload);
        }
      });
