...
"use strict";
/*!**************************************************************!*\
  !*** ./resources/js/frontend/modules/auth/reset-password.js ***!
  \**************************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initAuthResetPasswordPage() {
  var form = document.querySelector('[data-js="auth-reset-password-form"]');
  if (!(form instanceof HTMLFormElement)) {
    return;
  }
  var config = document.querySelector('[data-js="auth-reset-password-config"]');
