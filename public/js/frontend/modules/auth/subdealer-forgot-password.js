...
"use strict";
/*!*************************************************************************!*\
  !*** ./resources/js/frontend/modules/auth/subdealer-forgot-password.js ***!
  \*************************************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initSubDealerForgotPasswordPage() {
  var form = document.querySelector('[data-js="subdealer-forgot-password-form"]');
  if (!(form instanceof HTMLFormElement)) {
    return;
  }
  var config = document.querySelector('[data-js="subdealer-forgot-password-config"]');
  ...
  var successMessage = (config === null || config === void 0 ? void 0 : config.getAttribute('data-success-message')) || '';
  var confirmButtonText = (config === null || config === void 0 ? void 0 : config.getAttribute('data-confirm-button-text')) || 'Tamam';
  var loadingSubmitText = (config === null || config === void 0 ? void 0 : config.getAttribute('data-loading-submit-text')) || 'Gönderiliyor, lütfen bekleyin';
  ...
  form.addEventListener('submit', function (event) {
    ...
    var buttonState = setButtonLoadingText(submitButton, loadingSubmitText);
