...
"use strict";
/*!*****************************************************!*\
  !*** ./resources/js/frontend/modules/auth/login.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initAuthLoginPage() {
  var form = document.querySelector('[data-js="auth-login-form"]');
  if (!(form instanceof HTMLFormElement)) {
    return;
  }
  var config = document.querySelector('[data-js="auth-login-config"]');
  ...
  if (changePasswordForm instanceof HTMLFormElement) {
    changePasswordForm.addEventListener('submit', function (event) {
      ...
      event.preventDefault();
      var submitButton = changePasswordForm.querySelector('button[type="submit"]') || document.querySelector('button[form="changePasswordModalForm"]');
  ...
  document.addEventListener('click', function (event) {
    var toggleButton = event.target.closest('[data-action="toggle-password"], [data-toggle="password"]');
    if (!toggleButton) {
      return;
    }
    var passwordInput = form.querySelector('#password') || form.querySelector('input[name="password"]');
    ...
    var showLabel = toggleButton.getAttribute('data-label-show') || 'Şifreyi göster';
    var hideLabel = toggleButton.getAttribute('data-label-hide') || 'Şifreyi gizle';
