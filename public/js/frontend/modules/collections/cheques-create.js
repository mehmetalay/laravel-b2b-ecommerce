...
"use strict";
/*!*********************************************************************!*\
  !*** ./resources/js/frontend/modules/collections/cheques-create.js ***!
  \*********************************************************************/
__webpack_require__.r(__webpack_exports__);
...
(function initChequesCreatePage() {
  ...
  var config = document.querySelector('[data-js="cheques-create-config"]');
  if (!config) {
    return;
  }
  var createTitle = config.getAttribute('data-create-title') || 'Çek oluştur';
  var editTitle = config.getAttribute('data-edit-title') || 'Çek düzenle';
  ...
  var notePrefix = config.getAttribute('data-note-prefix') || 'Çek';
  ...
  var tableBody = document.querySelector('#cheque-table tbody');
  var saveButtonContainer = document.getElementById('save-button');
  var saveButton = document.querySelector('[data-js="save-button"]');
  var modalForm = document.getElementById('cheque-modal-form');
  var modalButton = document.getElementById('cheque-modal-button');
  var notesField = document.getElementById('notes');
  var collectionDateField = document.getElementById('collection_date');
  var modalLabel = document.getElementById('cheque-modal-label');
  ...
  var rowCellsToPayload = function rowCellsToPayload(row) {
    var _cells$, _cells$2, _cells$3, _cells$4, _cells$5, _cells$6, _cells$7, _cells$8, _cells$9;
    ...
    return {
      ...
      bank_name: ((_cells$7 = cells[6]) === null || _cells$7 === void 0 || (_cells$7 = _cells$7.textContent) === null || _cells$7 === void 0 ? void 0 : _cells$7.trim()) || '',
      branch_code: ((_cells$8 = cells[7]) === null || _cells$8 === void 0 || (_cells$8 = _cells$8.textContent) === null || _cells$8 === void 0 ? void 0 : _cells$8.trim()) || '',
      iban: ((_cells$9 = cells[8]) === null || _cells$9 === void 0 || (_cells$9 = _cells$9.textContent) === null || _cells$9 === void 0 ? void 0 : _cells$9.trim()) || ''
    };
  };
  var getModalValues = function getModalValues() {
    var _modalFields$serial_n, _modalFields$maturity, _modalFields$clio_typ, _modalFields$debtor, _modalFields$amount, _modalFields$currency, _modalFields$bank_nam, _modalFields$branch_c, _modalFields$iban;
    return {
      ...
      bankName: ((_modalFields$bank_nam = modalFields.bank_name) === null || _modalFields$bank_nam === void 0 || (_modalFields$bank_nam = _modalFields$bank_nam.value) === null || _modalFields$bank_nam === void 0 ? void 0 : _modalFields$bank_nam.trim()) || '',
      branchCode: ((_modalFields$branch_c = modalFields.branch_code) === null || _modalFields$branch_c === void 0 || (_modalFields$branch_c = _modalFields$branch_c.value) === null || _modalFields$branch_c === void 0 ? void 0 : _modalFields$branch_c.trim()) || '',
      iban: ((_modalFields$iban = modalFields.iban) === null || _modalFields$iban === void 0 || (_modalFields$iban = _modalFields$iban.value) === null || _modalFields$iban === void 0 ? void 0 : _modalFields$iban.trim()) || ''
    };
  };
  var renderRow = function renderRow(values, maturityDate) {
    return "<tr>\n        <td>".concat(values.serialNumber, "</td>\n        <td>").concat(maturityDate, "</td>\n        <td>").concat(values.clioType, "</td>\n        <td>").concat(values.debtor, "</td>\n        <td>").concat(values.amount, "</td>\n        <td>").concat(values.currencyType, "</td>\n        <td>").concat(values.bankName, "</td>\n        <td>").concat(values.branchCode, "</td>\n        <td>").concat(values.iban, "</td>\n        <td>\n            <a href=\"javascript:;\" data-js=\"edit-row\"><span class=\"badge alert-info\"><i class=\"fa-solid fa-pencil\"></i></span></a>\n            <a href=\"javascript:;\" data-js=\"delete-row\"><span class=\"badge alert-danger\"><i class=\"fa-solid fa-trash\"></i></span></a>\n        </td>\n    </tr>");
  };
  ...
  document.addEventListener('click', function (event) {
    var createTrigger = event.target.closest('[data-js="cheque-modal"]');
    if (createTrigger) {
      ...
      resetModal();
      setDebtorByClioType();
      (0,_shared__WEBPACK_IMPORTED_MODULE_0__.showModalById)('cheque-modal');
      return;
    }
    var editTrigger = event.target.closest('[data-js="edit-row"]');
    if (editTrigger) {
      var _cells$0, _cells$1, _cells$10, _cells$11, _cells$12, _cells$13, _cells$14, _cells$15, _cells$16, _tableBody$querySelec;
      event.preventDefault();
      ...
      var cells = row.querySelectorAll('td');
      var maturityDateText = ((_cells$0 = cells[1]) === null || _cells$0 === void 0 || (_cells$0 = _cells$0.textContent) === null || _cells$0 === void 0 ? void 0 : _cells$0.trim()) || '';
      ...
      modalFields.serial_number.value = ((_cells$1 = cells[0]) === null || _cells$1 === void 0 || (_cells$1 = _cells$1.textContent) === null || _cells$1 === void 0 ? void 0 : _cells$1.trim()) || '';
      modalFields.maturity_date.value = formattedMaturityDate;
      modalFields.clio_type.value = ((_cells$10 = cells[2]) === null || _cells$10 === void 0 || (_cells$10 = _cells$10.textContent) === null || _cells$10 === void 0 ? void 0 : _cells$10.trim()) || '';
      modalFields.debtor.value = ((_cells$11 = cells[3]) === null || _cells$11 === void 0 || (_cells$11 = _cells$11.textContent) === null || _cells$11 === void 0 ? void 0 : _cells$11.trim()) || '';
      modalFields.amount.value = ((_cells$12 = cells[4]) === null || _cells$12 === void 0 || (_cells$12 = _cells$12.textContent) === null || _cells$12 === void 0 ? void 0 : _cells$12.trim()) || '';
      modalFields.currency_type.value = ((_cells$13 = cells[5]) === null || _cells$13 === void 0 || (_cells$13 = _cells$13.textContent) === null || _cells$13 === void 0 ? void 0 : _cells$13.trim()) || '';
      modalFields.bank_name.value = ((_cells$14 = cells[6]) === null || _cells$14 === void 0 || (_cells$14 = _cells$14.textContent) === null || _cells$14 === void 0 ? void 0 : _cells$14.trim()) || '';
      modalFields.branch_code.value = ((_cells$15 = cells[7]) === null || _cells$15 === void 0 || (_cells$15 = _cells$15.textContent) === null || _cells$15 === void 0 ? void 0 : _cells$15.trim()) || '';
      modalFields.iban.value = ((_cells$16 = cells[8]) === null || _cells$16 === void 0 || (_cells$16 = _cells$16.textContent) === null || _cells$16 === void 0 ? void 0 : _cells$16.trim()) || '';
  ...
  modalButton.addEventListener('click', function (event) {
    ...
    (0,_shared__WEBPACK_IMPORTED_MODULE_0__.hideModalById)('cheque-modal');
    resetModal();
  });
  var modalElement = document.getElementById('cheque-modal');
  ...
  saveButton.addEventListener('click', function (event) {
    ...
    var cheques = Array.from(tableBody.querySelectorAll('tr')).map(function (row) {
