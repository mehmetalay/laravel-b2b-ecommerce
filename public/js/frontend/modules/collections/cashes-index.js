...
/***/ "./resources/js/frontend/modules/collections/cashes-create.js":
/*!********************************************************************!*\
  !*** ./resources/js/frontend/modules/collections/cashes-create.js ***!
  \********************************************************************/
...
/* harmony export */   registerCashesCreateBindings: () => (/* binding */ registerCashesCreateBindings)
/* harmony export */ });
...
function registerCashesCreateBindings() {
  document.addEventListener('change', function (event) {
    ...
    if (target.getAttribute('data-action') !== 'cashes-currency-change' && target.id !== 'currency_type') {
      return;
    }
    var form = target.closest('[data-js="cashes-add-edit-form"]');
    if (!form) {
      return;
    }
    var notesElement = form.querySelector('#notes');
    var notePrefix = target.getAttribute('data-note-prefix') || 'Nakit';
...
"use strict";
/*!*******************************************************************!*\
  !*** ./resources/js/frontend/modules/collections/cashes-index.js ***!
  \*******************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared */ "./resources/js/frontend/modules/collections/shared.js");
/* harmony import */ var _cashes_create__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cashes-create */ "./resources/js/frontend/modules/collections/cashes-create.js");


(function initCashesIndexPage() {
  var config = document.querySelector('[data-js="cashes-index-config"]');
  if (!config) {
    return;
  }
  ...
  var emptyRowText = config.getAttribute('data-empty-row-text') || 'Veri yok';
  ...
  var notifyCollectionRequestError = function notifyCollectionRequestError(errorPayload) {
    ...
    (_window$notify2 = (_window2 = window).notify) === null || _window$notify2 === void 0 || _window$notify2.call(_window2, 'error', (errorPayload === null || errorPayload === void 0 ? void 0 : errorPayload.message) || requestErrorMessage);
  };
  var notifyCollectionWarning = function notifyCollectionWarning(payload) {
    var _window$notify3, _window3;
    (_window$notify3 = (_window3 = window).notify) === null || _window$notify3 === void 0 || _window$notify3.call(_window3, payload !== null && payload !== void 0 && payload.warning ? 'warning' : 'error', payload !== null && payload !== void 0 && payload.warning ? payload.warning : payload === null || payload === void 0 ? void 0 : payload.error);
  };
  (0,_cashes_create__WEBPACK_IMPORTED_MODULE_1__.registerCashesCreateBindings)();
  var formatPriceInputs = function formatPriceInputs() {
    var scope = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
    var toFormatterInput = function toFormatterInput(inputElement) {
      if (typeof window.jQuery === 'function') {
        return window.jQuery(inputElement);
      }
      return inputElement;
    };
    var toNumericCaret = function toNumericCaret(value) {
      return Number.isFinite(value) ? value : 0;
    };
    var inputs = scope.querySelectorAll("input[data-format='price']");
    inputs.forEach(function (input) {
      ...
      input.addEventListener('input', function () {
        var formatterInput = toFormatterInput(input);
        if (typeof window.getCaretPosition !== 'function') {
          return;
        }
        var caretPos = toNumericCaret(window.getCaretPosition(formatterInput));
  ...
  document.addEventListener('click', function (event) {
    var trigger = event.target.closest('[data-js="add-edit"]');
    if (!trigger) {
      return;
    }
    ...
    window.axios.get(url).then(function (response) {
      var modalTitle = document.getElementById('add-edit-modal-label');
      var modalBody = document.getElementById('add-edit-modal-body');
      if (modalTitle) {
      ...
      (0,_shared__WEBPACK_IMPORTED_MODULE_0__.showModalById)('add-edit-modal');
    })["catch"](function () {
      var _window$notify4, _window4;
      (_window$notify4 = (_window4 = window).notify) === null || _window$notify4 === void 0 || _window$notify4.call(_window4, 'error', requestErrorMessage);
    });
  });
  document.addEventListener('submit', function (event) {
    var _window$setLoading, _window5;
    var form = event.target;
    if (!(form instanceof HTMLFormElement) || form.id !== 'add-edit-modal-form') {
      return;
    }
    event.preventDefault();
    var submitButton = document.getElementById('add-edit-modal-button');
    var restoreButtonText = (0,_shared__WEBPACK_IMPORTED_MODULE_0__.setButtonLoadingText)(submitButton, processingText);
    (_window$setLoading = (_window5 = window).setLoading) === null || _window$setLoading === void 0 || _window$setLoading.call(_window5, submitButton, true);
    (0,_shared__WEBPACK_IMPORTED_MODULE_0__.requestPost)(form.action, (0,_shared__WEBPACK_IMPORTED_MODULE_0__.serializeForm)(form), {
      onSuccess: function onSuccess(data) {
        var _window$setLoading3, _window8;
        if (data.success) {
          var _window$notify5, _window6, _window$setLoading2, _window7;
          var tableBody = document.getElementById('table-body');
          if (tableBody) {
            if (data.type === 'add') {
              var emptyRow = Array.from(tableBody.querySelectorAll('tr')).find(function (row) {
                var _row$textContent;
                return (_row$textContent = row.textContent) === null || _row$textContent === void 0 ? void 0 : _row$textContent.includes(emptyRowText);
              });
              emptyRow === null || emptyRow === void 0 || emptyRow.remove();
              tableBody.insertAdjacentHTML('afterbegin', data.row);
            } else {
              var targetRow = document.getElementById("parent-".concat(data.id));
              if (targetRow) {
                targetRow.outerHTML = data.row;
              }
            }
          }
          (_window$notify5 = (_window6 = window).notify) === null || _window$notify5 === void 0 || _window$notify5.call(_window6, 'success', data.message);
          (0,_shared__WEBPACK_IMPORTED_MODULE_0__.hideModalById)('add-edit-modal');
          restoreButtonText();
          (_window$setLoading2 = (_window7 = window).setLoading) === null || _window$setLoading2 === void 0 || _window$setLoading2.call(_window7, submitButton, false);
          return;
        }
        restoreButtonText();
        (_window$setLoading3 = (_window8 = window).setLoading) === null || _window$setLoading3 === void 0 || _window$setLoading3.call(_window8, submitButton, false);
        notifyCollectionWarning(data);
      },
      onValidationError: function onValidationError(errors) {
        var _window$setLoading4, _window9;
        restoreButtonText();
        (_window$setLoading4 = (_window9 = window).setLoading) === null || _window$setLoading4 === void 0 || _window$setLoading4.call(_window9, submitButton, false);
        notifyCollectionValidationError(errors);
      },
      onError: function onError(errorPayload) {
        var _window$setLoading5, _window0;
        restoreButtonText();
        (_window$setLoading5 = (_window0 = window).setLoading) === null || _window$setLoading5 === void 0 || _window$setLoading5.call(_window0, submitButton, false);
