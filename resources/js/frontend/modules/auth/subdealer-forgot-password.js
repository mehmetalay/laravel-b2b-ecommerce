...
(function initSubDealerForgotPasswordPage() {
    const form = document.querySelector('[data-js="subdealer-forgot-password-form"]');
    if (!(form instanceof HTMLFormElement)) {
        return;
    }

    const config = document.querySelector('[data-js="subdealer-forgot-password-config"]');
    ...
    const loadingSubmitText =
        config?.getAttribute('data-loading-submit-text') || 'Gönderiliyor, lütfen bekleyin';
