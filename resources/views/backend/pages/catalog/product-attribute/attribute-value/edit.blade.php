<form action="{{ route('admin.catalog.product-attributes.attributes.attribute-values.update', ['attribute' => $attribute->id, 'attribute_value' => $model->id]) }}" method="POST" id="add-edit-modal-form">
    @csrf
    @method('PATCH')
