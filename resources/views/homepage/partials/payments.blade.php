                   ...
                   @php
                    ...
                    <picture>
                        <source
                            ...
                            data-srcset="{{ image_url($mobileImage['file'], 'payment_slider.' . $mobileImage['device']) }}">

                        <source
                            media="(max-width: 1024px)"
                            data-srcset="{{ image_url($tabletImage['file'], 'payment_slider.' . $tabletImage['device']) }}">

                        <img
                            src="{{ image_url($desktopImage['file'], 'payment_slider.' . $desktopImage['device']) }}"
