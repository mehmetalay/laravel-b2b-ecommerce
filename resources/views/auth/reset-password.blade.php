            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
<div
                                data-js="auth-reset-password-config"
                                ...
                                hidden
                            ></div>
                            <form class="row g-4" id="reset-form" action="{{ route('password.reset', ['code' => $resetCode]) }}" method="POST" data-js="auth-reset-password-form">
                                @csrf
                                <div class="col-12">
...
@push('scripts')
    <script src="{{ mix('js/frontend/modules/auth/reset-password.js') }}"></script>
@endpush
