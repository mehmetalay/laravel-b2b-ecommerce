            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
<div
                                data-js="subdealer-forgot-password-config"
                                ...
                                data-loading-submit-text="{{ trans('translations.auth.gonderiliyor_lutfen_bekleyin') }}"
                                hidden
                            ></div>
                            <form class="row g-4" id="forgot-form" method="POST" action="{{ route('sub-dealer.password.forgot') }}" data-js="subdealer-forgot-password-form">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input type="text" class="form-control" name="username" id="username" placeholder="{{ trans('translations.auth.kullanici_adi') }}" autofocus>
                                ...
                                <div class="col-12">
                                    <div class="forgot-box justify-content-center">
                                        <a href="{{ route('sub-dealer.login.form') }}" class="forgot-password"><small>{{ trans('translations.auth.giris_sayfasina_don') }}</small></a>
                                    </div>
                                </div>
                            </form>
...
@push('scripts')
    <script src="{{ mix('js/frontend/modules/auth/subdealer-forgot-password.js') }}"></script>
@endpush
