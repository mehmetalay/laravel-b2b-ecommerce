                        ...
                        @php
                            ...
                            <picture>
                                <source
                                    ...
                                    data-srcset="{{ image_url($mobileImage['file'], 'category_slider.' . $mobileImage['device']) }}">

                                <source
                                    media="(max-width: 1024px)"
                                    data-srcset="{{ image_url($tabletImage['file'], 'category_slider.' . $tabletImage['device']) }}">

                                <img
                                    src="{{ image_url(config('images.default.lazy_load'), 'product.small') }}"
                                    data-src="{{ image_url($desktopImage['file'], 'category_slider.' . $desktopImage['device']) }}"
