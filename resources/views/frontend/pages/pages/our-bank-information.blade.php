                        ...
                        <div>
                            @if (app()->getLocale() == 'tr')
                                <div class="review-title mb-4">
                                    <h3><strong>ÜNVANIMIZ:</strong> {{ general_info('company_official_name', config('app.name')) }}</h3>
                                </div>
                            ...
                            @if (app()->getLocale() == 'en')
                                <div class="review-title mb-4">
                                    <h3><strong>OUR TITLE:</strong> {{ general_info('company_official_name', config('app.name')) }}</h3>
                                </div>
                                <div class="table-responsive">
                                    <table class="table order-tab-table">
                                        <thead>
