...
@section('content')
    <x-backend.breadcrumb :items="[
        ...
        <li class="nav-item">
            <a href="{{ route('admin.salesmans.create') }}" class="btn btn-info dash-btn">
                            ...
                            <div class="col-sm-12 col-md-4 filtered-list-search align-self-center">
                                <form class="form-group" method="GET" accept-charset="utf-8">
                                    <div class="input-group">
                                        <x-backend.input id="name" type="text" :value="request()->get('name')" placeholder="Plasiyer adı, kodu, e-posta adresi.." />
                                ...
                                <tbody>
                                    @forelse ($items as $item)
                                        <tr id="parent-{{ $item->id }}">
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.salesmans.edit', [$item->id]) }}" title="Düzenle" class="btn btn-info font-15 p-2"><i class="las la-edit"></i></a>
                                                <a href="javascript:;" class="btn btn-danger font-15 p-2" data-selector="row-delete" data-url="{{ route('admin.salesmans.destroy', [$item->id]) }}" title="Sil"><i class="las la-trash"></i></a>
                                            </td>
                                        </tr>
                                    @empty
