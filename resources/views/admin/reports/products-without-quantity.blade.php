...
@section('title', 'Adedi Olmayan Ürünler')

@section('content')
    <x-backend.breadcrumb :items="[
            ['url' => 'javascript:;', 'label' => 'Raporlar'],
            ['url' => route('admin.report.products-without-quantity'), 'label' => 'Adedi Olmayan Ürünler']
        ]">
        <li class="nav-item">
            <a class="btn btn-success dash-btn" href="javascript:;" data-download-url="{{ route('excel.export.products-without-quantity') }}" data-file-name="adedi-olmayan-urunler" data-download-file>
