...
<body>
    ...
    @if (Route::is('admin.payment-links.create') || Route::is('admin.payment-links.edit'))
        <script src="{{ mix('js/admin/modules/payments/index.js') }}"></script>
    @endif
    <script>
    ...
    @if (
        ...
        <script src="{{ mix('js/admin/modules/campaigns/index.js') }}"></script>
    @endif

    @if (Route::is('admin.settings.additional-settings.index'))
        <script src="{{ mix('js/admin/modules/settings/additional-settings-tagify.js') }}"></script>
    @endif

    @if (Route::is('admin.catalog.homepage-blocks.products'))
        <script src="{{ mix('js/admin/modules/homepage-blocks/index.js') }}"></script>
    @endif
